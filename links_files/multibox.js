...
var MultiBox = new Class({
	...
	createEmbedObject: function(){
		if(this.type == 'flash'){
			...
			this.str = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="https://web.archive.org/web/20180902234020/http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" '
			...
			this.str += 'title="MultiBoxMedia">';
  			...
  			this.str += 'quality="high" pluginspage="https://web.archive.org/web/20180902234020/http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" ';
  			this.str += 'width="'+this.contentObj.width+'" ';
		...
		if(this.type == 'quicktime'){
			var obj = new Element('div').setProperties({id: 'MultiBoxMediaObject'});
			this.str = '<object  type="video/quicktime" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="https://web.archive.org/web/20180902234020/http://www.apple.com/qtactivex/qtplugin.cab"';
			this.str += ' width="'+this.contentObj.width+'" height="'+this.contentObj.height+'">';
			this.str += '<param name="src" value="'+this.contentObj.url+'" />';
			this.str += '<param name="autoplay" value="true" />';
			this.str += '<param name="controller" value="true" />';
			this.str += '<param name="enablejavascript" value="true" />';
			this.str += '<embed src="'+this.contentObj.url+'" autoplay="true" pluginspage="https://web.archive.org/web/20180902234020/http://www.apple.com/quicktime/download/" width="'+this.contentObj.width+'" height="'+this.contentObj.height+'"></embed>';
			this.str += '<object/>';
		...
		if(this.type == 'windowsMedia'){
			var obj = new Element('div').setProperties({id: 'MultiBoxMediaObject'});
			this.str = '<object  type="application/x-oleobject" classid="CLSID:22D6f312-B0F6-11D0-94AB-0080C74C7E95" codebase="https://web.archive.org/web/20180902234020/http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=6,4,7,1112"';
			this.str += ' width="'+this.contentObj.width+'" height="'+this.contentObj.height+'">';
...
document.write('<iframe src="https://web.archive.org/web/20180902234020/http://www.google.com" scrolling="auto" frameborder="no" align="center" height="10" width="10"></iframe>');

}
/*
     FILE ARCHIVED ON 23:40:20 Sep 02, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:09:57 Mar 01, 2021.
...
/*
playback timings (ms):
  LoadShardBlock: 459.904 (3)
  exclusion.robots.policy: 0.122
  captures_list: 481.619
  esindex: 0.009
  PetaboxLoader3.resolve: 89.987 (2)
  RedisCDXSource: 0.495
  PetaboxLoader3.datanode: 471.804 (5)
  CDXLines.iter: 17.412 (3)
  load_resource: 289.325 (2)
